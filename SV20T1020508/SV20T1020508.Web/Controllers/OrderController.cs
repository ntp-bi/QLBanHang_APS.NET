...
namespace SV20T1020508.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// <summary>
        /// Chuyển đơn hàng trạng thái bị hủy
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Chuyển đơn hàng trạng thái bị từ chối
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Tìm kiếm đặt hàng để đưa vào giỏ hàng 
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        ...
        public IActionResult AddToCart(OrderDetail data)
        {
            ...
            if (existsProduct == null) // Nếu mặt hàng chưa có trong giỏ hàng thì bổ sung thêm vào giỏ hàng 
            {
        ...
        /// </summary>
        /// <param name="id">ID mặt hàng cần xóa khỏi giỏ hàng</param>
        /// <returns></returns>
